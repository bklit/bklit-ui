...
export function HomeComponents() {
  return (
    <>
      {/* Row 1: Radar + stacked Line & Area - heights match via flex */}
      <div className="col-span-full flex flex-col gap-4 sm:flex-row">
        <ShowcaseCard className="flex min-h-[300px] flex-col gap-4 sm:basis-3/7">
        ...
        <div className="flex flex-1 flex-col gap-4 sm:basis-4/7">
