...
export const Shopify = ({ height = "22px", className }: ShopifyProps) => {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M208.6,48.4c-6.7,0-11.9,3.2-16,8l-0.2-0.1l5.8-30.4H183l-14.7,77.3h15.1l5-26.4c2-10,7.1-16.1,11.9-16.1c3.4,0,4.7,2.3,4.7,5.6c0,2.1-0.2,4.6-0.7,6.7l-5.7,30.3h15.1l5.9-31.2c0.7-3.3,1.1-7.2,1.1-9.9C220.9,53.5,216.5,48.4,208.6,48.4z"
        fill="currentColor"
      />
      <path
        d="M255.1,48.4c-18.2,0-30.3,16.4-30.3,34.7c0,11.7,7.2,21.2,20.8,21.2c17.9,0,29.9-16,29.9-34.7C275.6,58.7,269.3,48.4,255.1,48.4z M247.7,92.6c-5.2,0-7.3-4.4-7.3-9.9c0-8.7,4.5-22.8,12.7-22.8c5.4,0,7.1,4.6,7.1,9.1C260.2,78.4,255.7,92.6,247.7,92.6z"
        fill="currentColor"
      />
      <path
      ...
      />
      <path
        d="M351.5,26.7c-4.8,0-8.7,3.8-8.7,8.8c0,4.5,2.8,7.6,7.1,7.6h0.2c4.7,0,8.8-3.2,8.9-8.8C359.1,29.8,356.1,26.7,351.5,26.7z"
        fill="currentColor"
      />
      <polygon
        fill="currentColor"
