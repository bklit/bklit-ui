...
Use [`Background`](/docs/utility/background) instead of `Grid` for a pattern fill behind candles. See **Pattern Background** examples on the [candlestick chart gallery](/charts/candlestick-chart).
