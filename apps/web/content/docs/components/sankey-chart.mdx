...
import { SankeyPatternDemo } from "@/components/docs/sankey-pattern-demo";
...
<div className="my-6 w-full">
  <SankeyChart data={analyticsData} aspectRatio="16 / 9" nodeWidth={16} nodePadding={24} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
    <SankeyLink />
