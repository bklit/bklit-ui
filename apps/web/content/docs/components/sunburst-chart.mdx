...
| `hoverPop` | `number` | `10` | Leaf segment grow distance on hover (px) |
...
Renders one arc with enter animation, drill-down click handling, and hover grow on leaf nodes.
...
4. **Hover grow** — Leaf segments in the hovered subtree extend outward
5. **Fade** — Unrelated segments dim when another branch is hovered
