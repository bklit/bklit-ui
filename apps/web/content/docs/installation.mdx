...
Line chart loading labels use [`@ncdai/shimmering-text`](https://chanhdai.com/components/shimmering-text). Installing `@bklit/line-chart` pulls it in automatically when `@ncdai` is configured.
