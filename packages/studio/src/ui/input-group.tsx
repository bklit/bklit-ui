/* biome-ignore-all lint/a11y/noNoninteractiveElementInteractions: shadcn input-group addon focus delegation */
/* biome-ignore-all lint/a11y/useKeyWithClickEvents: shadcn input-group addon focus delegation */
/* biome-ignore-all lint/a11y/useSemanticElements: shadcn input-group uses role=group */
"use client";
